...
class NotificationType:
    ...
    RESERVATION_REQUESTED_PAYMENT = 'reservation_requested_payment'
    RESERVATION_FAILED_PAYMENT = 'reservation_failed_payment'

    RESERVATION_PAYMENT_SUCCESSFUL = 'reservation_payment_successful'
    RESERVATION_PAYMENT_SUCCESSFUL_OFFICIAL = 'reservation_payment_successful_official'
...
class NotificationTemplate(TranslatableModel):
    NOTIFICATION_TYPE_CHOICES = (
        ...
        (NotificationType.RESERVATION_REQUESTED_PAYMENT, _('Reservation requested payment')),
        (NotificationType.RESERVATION_FAILED_PAYMENT, _('Reservation failed payment')),
        (NotificationType.RESERVATION_PAYMENT_SUCCESSFUL, _('Reservation payment successful')),
        (NotificationType.RESERVATION_PAYMENT_SUCCESSFUL_OFFICIAL, _('Reservation payment successful official')),
    )
